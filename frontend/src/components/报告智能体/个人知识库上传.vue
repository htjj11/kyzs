...
const getTagList = async () => {
  try {
    const response = await request.post('/system/get_all_label', {
...
const uploadContent = async () => {
  ...
  try {
    if (uploadType.value === 'text') {
      const response = await request.post('/personal_knowledgebase/add_knowledge', {
        data_dict: {
      ...
      const response = await request.post(
        '/personal_knowledgebase/add_knowledge',
        {
