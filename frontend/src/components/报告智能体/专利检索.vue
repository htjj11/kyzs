  ...
  <div class="patent-container">
    <div class="search-form">
      <div class="form-row">
        ...
        <div class="form-item">
          <label>年份：</label>
          <el-input-number v-model="startYear" :min="1800" :max="currentYear" placeholder="起始" controls-position="right"
            style="width:120px" />
...
const handleLabelConfirm = async ({ label_id }) => {
  ...
  try {
    const resp = await request.post('/personal_knowledgebase/add_knowledge', {
