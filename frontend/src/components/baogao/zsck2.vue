<template>
  <div class="review-records-container">
    <h1>报告记录管理（新版富文本编辑器，与旧版格式不通用，请分别保存）</h1>
    <!-- 新增：新建空白报告按钮 -->
    ...
    <el-dialog
      ...
      :fullscreen="true"
    >
      <div class="detail-container" style="max-height: 85vh; overflow-y: auto; padding: 20px;">
        ...
        <div class="detail-item">
          ...
          <div class="review-body" v-html="currentRecord.review_body || '无内容'"></div>
          <el-button type="primary" size="small" @click="downloadWord(currentRecord.id)" style="margin-top: 12px;">下载Word</el-button>
        </div>
      </div>
      <template #footer>
...
.review-body h1 { font-size: 24px; }
.review-body h2 { font-size: 20px; }
.review-body h3 { font-size: 18px; }
.review-body h4 { font-size: 16px; }
